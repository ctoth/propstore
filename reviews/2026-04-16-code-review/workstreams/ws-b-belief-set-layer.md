...
- 2026-04-17: Documentation exit slice completed. Added red docs gate for `docs/belief-set-revision.md`, `docs/ic-merge.md`, and `docs/af-revision.md` (`logs\test-runs\ws-b-red-belief-set-docs-20260417-101311.log`), wrote the three docs against the implemented belief-set modules and support-revision boundary, and updated `CLAUDE.md`'s layer text to name formal belief dynamics explicitly. Verification slice passed: docs gate (`3 passed`, `logs\test-runs\ws-b-belief-set-docs-20260417-101419.log`) and `uv run pyright propstore/belief_set propstore/support_revision propstore/worldline/revision_capture.py propstore/worldline/revision_types.py propstore/context_types.py` (`0 errors`).
