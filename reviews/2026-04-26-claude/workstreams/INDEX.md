...
| **WS-P2** | Condition semantics surface | CLOSED dbc1e3c4 | P, N2 | — | successor spec; CEL frontend boundary, checked condition carrier, solver deletion, sidecar/runtime representation, architecture docs | delete `propstore.z3_conditions`; replace `CheckedCel*` production carriers with `CheckedConditionSet` / `ConditionIR`; docs gate covers `docs/cel-typed-expressions.md`, `docs/conflict-detection.md`, `docs/data-model.md`, `docs/python-api.md`, and architecture boundary docs; report: `reviews/2026-04-26-claude/workstreams/reports/WS-P2-closure.md` |
