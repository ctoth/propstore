...
| **WS-K2** | Meta-rule extraction pipeline | CLOSED 4a2ce545 | K | — | new spec; LLM extract → `proposal_rules` → human gate | **D-9 (LLM + proposal gate), D-10 (`knowledge/rules/<paper-name>/`)**; predicate-registration step explicit, no missing-skill reference (Codex 2.13); CLI tests for help/dry-run/propose/promote/unknown-id/no-commit-review (Codex 2.14); report: `reviews/2026-04-26-claude/workstreams/reports/WS-K2-closure.md` |
