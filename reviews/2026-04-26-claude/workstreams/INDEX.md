...
| **WS-P2** | Condition semantics surface | OPEN | P, N2 | — | successor spec; CEL frontend boundary, checked condition carrier, solver deletion, sidecar/runtime representation, architecture docs | delete `propstore.z3_conditions`; replace `CheckedCel*` production carriers with `CheckedConditionSet` / `ConditionIR`; docs gate covers `docs/cel-typed-expressions.md`, `docs/conflict-detection.md`, `docs/data-model.md`, `docs/python-api.md`, and architecture boundary docs |
