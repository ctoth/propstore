...
| WS-O-gun | gunray fixes + anytime wire-up | CLOSED v0.1.0 | — | M, H | 17 (cluster R HIGH/MED/LOW + ARCH/BND) | **D-17 (Garcia rewrite split off), D-18 (EnumerationExceeded wired)**; closed by pushed gunray tag `v0.1.0` at `1f3f960`; propstore pin and consumer budget surfacing remain WS-M gates; report: `reviews/2026-04-26-claude/workstreams/reports/WS-O-gun-closure.md` |
