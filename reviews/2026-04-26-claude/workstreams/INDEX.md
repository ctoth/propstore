...
| **WS-O-arg-vaf-completion** | Bench-Capon pp. 438-447 line-of-argument + fact-uncertainty VAF completion | OPEN | **O-arg-vaf-ranking** | — | new spec | Follow-up from 2026-04-28 image reread; not path-critical for WS-O-arg-gradual; tracks argument chains, lines of argument, parity classification, two-value cycle corollary, and fact-as-highest-value uncertainty; workstream: `reviews/2026-04-26-claude/workstreams/WS-O-arg-vaf-completion.md` |
