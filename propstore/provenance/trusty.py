...
byte-level hash carrier and emits only SHA-256 identifiers. These thin
re-exports give the provenance subsystem its own door to the canonical
``ni``-URI primitives that live in :mod:`propstore.uri`; there is no second
spelling of the hash logic.
"""
