...
class ConceptSearchHit:
    ...
    @classmethod
    def from_search_row(cls, data: Mapping[str, Any]) -> ConceptSearchHit:
...
class ClaimSimilarityHit:
    ...
    @classmethod
    def from_search_row(cls, data: Mapping[str, Any]) -> ClaimSimilarityHit:
        return cls(
            claim_id=data["id"],
...
class ConceptSimilarityHit:
    ...
    @classmethod
    def from_search_row(cls, data: Mapping[str, Any]) -> ConceptSimilarityHit:
        return cls(
            concept_id=data["id"],
            distance=float(data["distance"]),
            primary_logical_id=(
