...
This is the canonical home for the argumentation backend / semantics vocabulary.
Phase 7's ``world.types`` re-exports these names; they are defined here so the
conflict, projection, and analyzer layers can depend on them without pulling in
...
_CLI_ARGUMENTATION_SEMANTICS: tuple[ArgumentationSemantics, ...] = (
