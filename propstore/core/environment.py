...
from propstore.families.concepts.declaration import ConceptInput, ParameterizationInput
...
class ClaimCatalogStore(Protocol):
    def claims_for(self, concept_id: str | None) -> Sequence[ActiveClaimInput]: ...
...
class WorldStore(Protocol):
    ...
    def claims_for(self, concept_id: str | None) -> Sequence[ActiveClaimInput]: ...
    def claims_by_ids(self, claim_ids: set[str]) -> Mapping[str, ActiveClaimInput]: ...
    def stances_between(self, claim_ids: set[str]) -> Sequence[StanceRowInput]: ...
    def conflicts(self) -> Sequence[ConflictRowInput]: ...
    def all_concepts(self) -> Sequence[ConceptInput]: ...
    def all_parameterizations(self) -> Sequence[ParameterizationInput]: ...
