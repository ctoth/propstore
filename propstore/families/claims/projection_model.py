...
CLAIM_CORE_STORAGE_MODEL: ProjectionModel[dict[str, object]] = ProjectionModel(
    ...
    fields=(
        ...
        ScalarPath(("content_hash",), "content_hash", codec=TEXT_CODEC, nullable=False, default="", default_sql="''"),
        ...
        ScalarPath(("premise_kind",), "premise_kind", codec=TEXT_CODEC, nullable=False, default="ordinary", default_sql="'ordinary'"),
        ScalarPath(("branch",), "branch", codec=TEXT_CODEC),
        ScalarPath(("build_status",), "build_status", codec=TEXT_CODEC, nullable=False, default="ingested", default_sql="'ingested'"),
...
CLAIM_NUMERIC_PAYLOAD_STORAGE_MODEL: ProjectionModel[dict[str, object]] = ProjectionModel(
    ...
    result_type=dict,
    fields=(
        ReferencePath(("id",), "claim_id", family="claim_core", codec=CLAIM_ID_CODEC, nullable=False, primary_key=True, missing="raise"),
