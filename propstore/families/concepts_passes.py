...
class ConceptCheckPass:
    ...
    def run(
        ...
        for loaded in value.concepts:
            ...
            if (
                entry is not None
                and entry.physical_dimension_form
                and entry.physical_dimension_form not in form_registry
            ):
                warnings.append(
                    _diagnostic(
                        "warning",
                        ...
                        (
                            ...
                            f"'{entry.physical_dimension_form}'"
                        ),
                        loaded,
                        self.name,
                    )
        ...
        return PassResult(
            output=ConceptCheckedRegistry(concepts=value.concepts, by_id=by_id),
