...
def world_charter_catalog() -> SchemaCatalog:
    claim_models = _claim_models()
    return charter_catalog(
        _charter(
            "meta",
            WorldMeta,
            "key",
            _f("key", primary_key=True),
            _i("schema_version", nullable=False),
        ),
        source_charter(),
        _charter(
            "concept",
            Concept,
            "id",
            _f("id", primary_key=True),
            _f("primary_logical_id", nullable=False, default_sql="''"),
            _f("logical_ids_json", nullable=False, default_sql="'[]'"),
            _f("version_id", nullable=False, default_sql="''"),
            _f("content_hash", nullable=False),
            _i("seq", nullable=False),
            _f("canonical_name", nullable=False),
            _f("status", nullable=False),
            _f("domain"),
            _f("definition", nullable=False),
            _f("kind_type", nullable=False),
            _f("form", nullable=False),
            _f("form_parameters"),
            _r("range_min"),
            _r("range_max"),
            _i("is_dimensionless", nullable=False, default_sql="0"),
            _f("unit_symbol"),
            _f("created_date"),
            _f("last_modified"),
        ...
        _charter(
            ...
            ConceptAlias,
            "concept_id",
            _f("concept_id", nullable=False),
            _f("alias_name", nullable=False),
            _f("source", nullable=False),
            indexes=(
        ...
        _charter(
            ...
            Parameterization,
            "output_concept_id",
            _f("output_concept_id", nullable=False),
            _f("concept_ids", nullable=False),
            _f("formula", nullable=False),
            _f("sympy"),
            _f("exactness", nullable=False),
            _f("conditions_cel"),
            _f("conditions_ir"),
        ),
        _charter(
        ...
        _charter(
            ...
            ConceptRelationship,
            "source_id",
            _f("source_id", nullable=False),
            _f("type", nullable=False),
            _f("target_id", nullable=False),
            _f("conditions_cel"),
            _f("note"),
            indexes=(
        ...
        _charter(
            ...
            RelationEdge,
            "id",
            _i("id", primary_key=True, nullable=False, generated=True),
            _f("source_kind", nullable=False),
            _f("source_id", nullable=False),
            _f("relation_type", nullable=False),
            _f("target_kind", nullable=False),
            _f("target_id", nullable=False),
            _f("perspective_source_claim_id"),
            _f("target_justification_id"),
            _f("conditions_cel"),
            _f("strength"),
            _f("conditions_differ"),
            _f("note"),
            _f("resolution_method"),
            _f("resolution_model"),
            _f("embedding_model"),
            _r("embedding_distance"),
            _i("pass_number"),
            _r("confidence"),
            _r("opinion_belief"),
            _r("opinion_disbelief"),
            _r("opinion_uncertainty"),
            _r("opinion_base_rate"),
            indexes=(
        ...
        _charter(
            ...
            Form,
            "name",
            _f("name", primary_key=True),
            _f("kind", nullable=False),
            _f("unit_symbol"),
            _i("is_dimensionless", nullable=False, default_sql="0"),
            _f("dimensions"),
        ),
        _charter(
            ...
            FormAlgebra,
            "id",
            _i("id", primary_key=True, nullable=False),
            _f("output_form", nullable=False),
            _f("input_forms", nullable=False),
            _f("operation", nullable=False),
            _f("source_concept_id"),
            _f("source_formula"),
            _i("dim_verified", nullable=False, default_sql="1"),
        ...
        _charter(
            ...
            Context,
            "id",
            _f("id", primary_key=True, nullable=False),
            _f("name", nullable=False),
            _f("description"),
            _f("parameters_json"),
            _f("perspective"),
        ),
        _charter(
            ...
            ContextAssumption,
            "context_id",
            _f("context_id", nullable=False),
            _f("assumption_cel", nullable=False),
            _i("seq", nullable=False),
        ...
        _charter(
            ...
            "id",
            _f("id", primary_key=True, nullable=False),
            _f("source_context_id", nullable=False),
            _f("target_context_id", nullable=False),
            _f("conditions_cel"),
            _f("mode", nullable=False),
            _f("justification"),
            indexes=(
        ...
        _charter(
            ...
            ContextLiftingMaterialization,
            "id",
            _i("id", primary_key=True, nullable=True),
            _f("rule_id", nullable=False),
            _f("source_context_id", nullable=False),
            _f("target_context_id", nullable=False),
            _f("proposition_id", nullable=False),
            _f("status", nullable=False),
            _f("exception_id"),
            _f("provenance_json", nullable=False),
            indexes=(
        ...
        _claim_core_charter(claim_models),
        _charter(
            "claim_concept_link",
            claim_models["claim_concept_link"],
            "claim_id",
            CharterField(
                "claim_id",
                str,
                primary_key=True,
                nullable=False,
                foreign_key=_fk("claim_concept_link_claim", "claim_concept_link", "claim_id", "claim_core"),
            ),
            CharterField(
                "concept_id",
                str,
                primary_key=True,
                nullable=False,
                foreign_key=_fk("claim_concept_link_concept", "claim_concept_link", "concept_id", "concept"),
            ),
        ...
        *_claim_payload_charters(claim_models),
        _claim_source_assertion_charter(claim_models),
        _charter(
            "conflict_witness",
            ConflictWitness,
            "id",
            _i("id", primary_key=True, nullable=False, generated=True),
            _f("claim_a_id", nullable=False),
            _f("claim_b_id", nullable=False),
            _f("concept_id", nullable=False),
            _f("warning_class", nullable=False),
            _f("conditions_a"),
            _f("conditions_b"),
            _f("value_a"),
            _f("value_b"),
        ...
        _charter(
            ...
            GroundedFact,
            "predicate",
            _f("predicate", primary_key=True, nullable=False),
            _f("arguments", primary_key=True, nullable=False),
            _f("section", primary_key=True, nullable=False),
        ),
        _charter(
        ...
        _charter(
            ...
            GroundedBundleInput,
            "kind",
            _f("kind", primary_key=True, nullable=False),
            _i("position", primary_key=True, nullable=False),
            _b("payload", nullable=False),
        ),
        _charter(
            "justification",
            Justification,
            "id",
            _f("id", primary_key=True, nullable=False),
            _f("justification_kind", nullable=False),
            _f("conclusion_claim_id", nullable=False),
            _f("premise_claim_ids", nullable=False),
            _f("source_relation_type"),
            _f("source_claim_id"),
            _f("provenance_json"),
        ...
        _charter(
            ...
            _f("id", primary_key=True, nullable=False),
            _f("context_id", nullable=False),
            _f("assumptions_json", nullable=False, default_sql="'[]'"),
            _f("evidence_json", nullable=False, default_sql="'[]'"),
            _f("stance"),
            _f("provenance_json"),
            _f("source_slug"),
        ...
        _charter(
            ...
            CharterField(
                ...
                primary_key=True,
                nullable=False,
                foreign_key=_fk("micropublication_claim_micropublication", "micropublication_claim", "micropublication_id", "micropublication"),
            ),
            CharterField(
                "claim_id",
                str,
                primary_key=True,
                nullable=False,
                foreign_key=_fk("micropublication_claim_claim", "micropublication_claim", "claim_id", "claim_core"),
            ),
            _i("seq", nullable=False),
...
def _claim_core_charter(models: dict[str, type[Any]]) -> FamilyCharter:
    return _charter(
        "claim_core",
        models["claim_core"],
        "id",
        ...
        _f("logical_ids_json", nullable=False, default_sql="'[]'"),
        _f("version_id", nullable=False, default_sql="''"),
        _f("content_hash", nullable=False, default_sql="''"),
        _i("seq", nullable=False),
        ...
        _f("source_paper", nullable=False),
        _i("provenance_page", nullable=False),
        _f("provenance_json"),
        _f("context_id"),
        _f("premise_kind", nullable=False, default_sql="'ordinary'"),
        _f("branch"),
        _f("build_status", nullable=False, default_sql="'ingested'"),
        _f("stage"),
        _f("promotion_status"),
        indexes=(
...
def _claim_payload_charters(
    models: dict[str, type[Any]],
) -> tuple[FamilyCharter, FamilyCharter, FamilyCharter]:
    return (
        _charter(
            "claim_numeric_payload",
            models["claim_numeric_payload"],
            "claim_id",
            CharterField(
                "claim_id",
                str,
                primary_key=True,
                nullable=False,
                foreign_key=_fk("claim_numeric_payload_claim", "claim_numeric_payload", "claim_id", "claim_core"),
            ),
            _r("value"),
            _r("lower_bound"),
            _r("upper_bound"),
        ...
        _charter(
            ...
            CharterField(
                ...
                primary_key=True,
                nullable=False,
                foreign_key=_fk("claim_text_payload_claim", "claim_text_payload", "claim_id", "claim_core"),
            ),
            _f("conditions_cel"),
            _f("conditions_ir"),
            _f("statement"),
        ...
        _charter(
            ...
            models["claim_algorithm_payload"],
            "claim_id",
            CharterField(
                "claim_id",
                str,
                primary_key=True,
                nullable=False,
                foreign_key=_fk("claim_algorithm_payload_claim", "claim_algorithm_payload", "claim_id", "claim_core"),
            ),
            _f("body"),
            _f("canonical_ast"),
            _f("variables_json"),
...
def _claim_source_assertion_charter(models: dict[str, type[Any]]) -> FamilyCharter:
    return _charter(
        "claim_source_assertion",
        models["claim_source_assertion"],
        "claim_id",
        CharterField(
            "claim_id",
            str,
            primary_key=True,
            nullable=False,
            foreign_key=_fk("claim_source_assertion_claim", "claim_source_assertion", "claim_id", "claim_core"),
        ),
...
def _support_charters() -> tuple[FamilyCharter, FamilyCharter, FamilyCharter, FamilyCharter, FamilyCharter]:
    ...
    return (
        _charter(
            ...
            CalibrationCount,
            "pass_number",
            _i("pass_number", primary_key=True, nullable=False),
            _f("category", primary_key=True, nullable=False),
            _i("correct_count", nullable=False),
            _i("total_count", nullable=False),
        ),
        _charter(
            "embedding_model",
            EmbeddingModel,
            "model_identity_hash",
            _f("model_identity_hash", primary_key=True, nullable=False),
            _f("provider", nullable=False),
            _f("model_name", nullable=False),
            _f("model_version", nullable=False, default_sql="''"),
            _f("content_digest", nullable=False),
            _i("dimensions", nullable=False),
            _f("created_at", nullable=False),
        ),
        _charter(
            "embedding_status",
            EmbeddingStatus,
            "model_identity_hash",
            _f("model_identity_hash", primary_key=True, nullable=False),
            _f("claim_id", primary_key=True, nullable=False),
            _f("content_hash", nullable=False),
            _f("embedded_at", nullable=False),
        ...
        _charter(
            ...
            "model_identity_hash",
            _f("model_identity_hash", primary_key=True, nullable=False),
            _f("concept_id", primary_key=True, nullable=False),
            _f("content_hash", nullable=False),
            _f("embedded_at", nullable=False),
        ...
        _charter(
            ...
            _f("source_kind", nullable=False),
            _f("source_ref"),
            _f("diagnostic_kind", nullable=False),
            _f("severity", nullable=False),
            _i("blocking", nullable=False),
            _f("message", nullable=False),
            _f("file"),
            _f("detail_json"),
            indexes=(
