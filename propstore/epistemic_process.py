...
class ProcessCompletionRecord:
    ...
    journal_entry_hashes: tuple[str, ...] = ()
    result_payload: Mapping[str, Any] = field(default_factory=dict[str, Any])
...
class EpistemicProcessManager:
    queued_jobs: Mapping[str, QueuedProcessJob] = field(
        default_factory=dict[str, QueuedProcessJob]
    )
    completions: Mapping[str, ProcessCompletionRecord] = field(
        default_factory=dict[str, ProcessCompletionRecord]
    )
    ...
    def from_dict(cls, data: Mapping[str, Any]) -> EpistemicProcessManager:
        queued: dict[str, QueuedProcessJob] = {}
        ...
        completions: dict[str, ProcessCompletionRecord] = {}
