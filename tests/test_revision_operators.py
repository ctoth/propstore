    ...
    base = BeliefBase(
        ...
        atoms=(
            AssumptionAtom(
                "assumption:a_strong",
                AssumptionRef(
                    assumption_id="a_strong", kind="test", source="test", cel="true"
                ),
            ),
            AssumptionAtom(
                "assumption:b_medium",
                AssumptionRef(
                    assumption_id="b_medium", kind="test", source="test", cel="true"
                ),
            ),
            AssumptionAtom(
                "assumption:shared_weak",
                AssumptionRef(
                    assumption_id="shared_weak", kind="test", source="test", cel="true"
                ),
            ),
            legacy,
            dependent,
    ...
    base = BeliefBase(
        ...
        atoms=(
            AssumptionAtom(
                "assumption:a_weak",
                AssumptionRef(
                    assumption_id="a_weak", kind="test", source="test", cel="true"
                ),
            ...
            AssumptionAtom(
                "assumption:z_strong",
                AssumptionRef(
                    assumption_id="z_strong", kind="test", source="test", cel="true"
                ),
                label=Label(
                    (
