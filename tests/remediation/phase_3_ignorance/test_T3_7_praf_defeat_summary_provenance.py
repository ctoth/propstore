...
def test_summarized_defeat_opinions_are_calibrated_with_variance_uncertainty() -> None:
    ...
    assert "defeat_distribution_variance" in opinion.provenance.operations
    assert opinion.u > 0.0
