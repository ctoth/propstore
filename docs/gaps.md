...
- T3.8 / Cluster A HIGH-5 — source finalize blocks claims that cannot be represented as micropublications because required context is missing, and reports `micropub_coverage_errors`. Evidence: commits `f93628bf`, `37388421`, `09a3ef6d`; test `tests/test_finalize_micropub_required.py`.
