...
- **Temporal anchoring uses `KindType.TIMEPOINT`** (maps to `z3.Real`) plus `Z3ConditionSolver` providing Allen-1983 interval reasoning. Description-claims locate in time via TIMEPOINT-valued slot bindings; no new temporal layer.
