...
| `propstore/world/queries.py` active report naming | `WorldBindActiveReport` active-object spelling | World binding report over activation state | Rename to non-`Active*` report name and update callers. | `12-world-query-graph-reasoning.md` |
