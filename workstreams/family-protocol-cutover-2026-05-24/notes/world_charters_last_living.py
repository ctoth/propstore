...
def world_charter_catalog() -> SchemaCatalog:
    ...
    return charter_catalog(
        ...
        _charter(
            ...
            _f("last_modified"),
            indexes=(
                CharterIndex("idx_concept_primary_logical_id", ("primary_logical_id",)),
            ),
            reference_keys=(
        ...
        _charter(
            ...
            _i("seq", nullable=False),
            indexes=(
                CharterIndex("idx_context_assumption_context_id", ("context_id",)),
            ),
        ),
        _charter(
        ...
        _charter(
            ...
            CharterField(
                "role", ClaimConceptLinkRole, primary_key=True, nullable=False
            ),
        ...
        *_claim_payload_charters(claim_models),
        ...
        _charter(
            ...
            CharterField(
                ...
                nullable=False,
                foreign_key=_fk(
                    "micropublication_claim_micropublication",
                    "micropublication_claim",
                    "micropublication_id",
                    "micropublication",
                ),
    ...
    return (
        ...
        _charter(
            ...
            CharterField(
                ...
                str,
                metadata={
                    "semantic_type": "propstore.core.algorithm_stage.AlgorithmStage"
                },
            ),
...
def _support_charters() -> tuple[
    FamilyCharter, FamilyCharter, FamilyCharter, FamilyCharter, FamilyCharter
]:
    ...
    return (
        ...
        _charter(
            ...
            indexes=(
                ...
                CharterIndex(
                    "idx_build_diagnostics_source", ("source_kind", "source_ref")
                ),
            ),
        ),
    )
