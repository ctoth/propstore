...
- **Probabilistic extension of tree-decomposition approach:**
  - [[Popescu_2024_ProbabilisticArgumentationConstellation]] — **Strong.** Popescu & Wallner apply tree-decomposition DP directly to probabilistic AFs under the constellation approach, computing probability-weighted I/O/U labelling tables bottom-up. Complementary to this paper's SAT/QBF compilation: Fichte preserves treewidth for solver-based computation, Popescu runs DP directly on the decomposition for probabilistic queries. Same structural exploitation, different computation targets.
