...
The paper addresses the gap between identifying *which* arguments are acceptable (what standard semantics do) and explaining *why* they are acceptable. Related admissibility filters standard admissible sets to remove "freeloading" arguments that don't contribute to defense, yielding focused explanation sets. The dispute forest mechanism provides an implementable algorithm for computing these explanations, making it directly applicable to systems that need to justify argumentation outcomes to users.
