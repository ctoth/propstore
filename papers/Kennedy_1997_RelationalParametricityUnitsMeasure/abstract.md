...
Kennedy treats units of measure as a parametric type dimension rather than a runtime tag. The paper's strongest implementation lesson is that a dimension/unit type can generate proof obligations and scaling laws, not merely reject mismatched equations. For bridgman and propstore, this points toward carrying scale-invariance witnesses and Pi-theorem reductions alongside dimensional validation.
