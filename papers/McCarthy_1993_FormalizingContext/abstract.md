...
McCarthy formalizes contexts as first-class logical objects with ist(c, p) as the basic truth-in-context relation, enabling AI systems to reason across different contextual boundaries via lifting rules. The key insight is transcendence — the ability to expand limited axiomatizations beyond their original scope by making context boundaries explicit and crossable. This is foundational for any system (like propstore) that needs to hold multiple rival interpretations and relate claims across different theoretical or experimental contexts.
