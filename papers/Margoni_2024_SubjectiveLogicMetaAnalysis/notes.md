...
- [[vanderHeijden_2018_MultiSourceFusionOperationsSubjectiveLogic]] — provides corrected multi-source WBF formula and proves its equivalence to confidence-weighted Dirichlet averaging (Theorem 1); directly validates the WBF fusion Margoni applies to 67 findings
