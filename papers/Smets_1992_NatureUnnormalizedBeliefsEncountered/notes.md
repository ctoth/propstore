...
- [Revisions of Knowledge Systems Using Epistemic Entrenchment](../Gardenfors_1988_RevisionsKnowledgeSystemsEntrenchment/notes.md) - Gärdenfors and Makinson's epistemic-entrenchment framework is the AGM analogue of Smets's "store credal state, defer commitment"; both insist epistemic dynamics belong on a layer above propositional commitment.
