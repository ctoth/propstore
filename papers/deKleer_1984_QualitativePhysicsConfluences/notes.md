...
- **Classical physics obscures qualitative insight.** Quantitative descriptions using continuous real-valued variables and differential equations "fail to provide much insight" into the qualitative distinctions (state, cause, oscillation, gain, momentum) that humans actually use to understand physical mechanisms. The insightful concepts "are usually qualitative, but they are embedded within the much more complex framework established by continuous real-valued variables and differential equations." *(p.7--8)*
- **Expert systems lack commonsense physical reasoning.** "A commonly recognized failing of such systems is their extremely narrow range of expertise and their inability to recognize when a problem posed to them is outside this range of expertise. In other words, they have no commonsense and cannot solve simpler versions of the problems they are designed to solve." *(p.8)*
- **Modern physics provides no formalism for causality.** Physical laws viewed as constraints are acausal --- "modern physics provides no formalism for treating" causal explanation. The paper argues that causality requires a separate ontological commitment beyond what constraint-based physics offers. *(p.8, 12)*
- **Prior qualitative physics programs lack unifying framework.** Research under titles like "qualitative process theory," "commonsense knowledge," and "mechanistic mental models" each approaches the task differently, with no shared theoretical foundation. *(p.13)*
- **Textbook physics is the tip of the iceberg.** "The knowledge presented in textbooks is but the tip of the iceberg about what actually needs to be known to reason about the physical world." Physical laws are "all based on the presupposition of a shared unstated commonsense prephysics knowledge," which is why AI has been "rather unsuccessful at building systems that require physics problem-solving." *(p.13--14)*
- **Hayes' naive physics lacks causal distinction.** Hayes [17] does not distinguish "how" a physical system achieves its behavior from "what" the behavior is. "Thus distinguishing 'how' from 'what' carries little weight in his framework." De Kleer and Brown argue that accounting for *how* devices work is a "proper task of naive physics." *(p.14)*
- **Level-1 acausal analysis is inadequate.** Simple acausal analysis using level-1 models (without mass/spring) "was inadequate in that it neither explained how that behavior was produced, nor revealed important characteristics about its operation such as oscillation." This motivates the development of both level-2 models and mythical causality. *(p.76)*
- **Quasistatic models cannot account for change.** "All these complications and impediments concerning causality come as a result of asking the question 'How does change come about?' Modern physics tends to sidestep this question by adopting a modeling perspective which cannot, in principle, account for change." The quasistatic approximation assumes the device is always infinitesimally near equilibrium, making causal transitions invisible. *(p.62)*

## Design Rationale

- **Trade precision for qualitative insight.** The central design decision is to reduce continuous real-valued variables to a three-valued set {+, 0, -}, sacrificing quantitative precision to retain "all the important qualitative distinctions" while making reasoning tractable. *(p.7--8)*
- **Six paradigmatic assumptions structure the framework.** The qualitative physics is built on explicit foundational commitments: (1) quasistatic approximation, (2) causality as ontological principle, (3) generalized machines, (4) locality, (5) digital physics, (6) proof as explanation. *(p.12--13)*
- **Causality as ontological commitment, not epiphenomenon.** Device behavior is viewed as *arising from* time-ordered cause-effect interactions between neighboring components. This is a deliberate ontological commitment: "our use of causality as an ontological principle results in a very mechanistic world view." *(p.12, 15)*
- **No-function-in-structure principle.** "The laws of the parts of a device may not presume the functioning of the whole." This prevents circular reasoning where component models assume the device already works correctly. The principle is implemented through class-wide assumptions that make implicit modeling assumptions explicit. *(p.16--17)*
- **Digital physics as computational metaphor.** Each component is modeled as a simple information processor; overall behavior emerges from causal interactions between adjacent processors. "A new kind of physical law might thus be expressible as constraints on these programs, processors, or the information-flow among them." *(p.13, 76--77)*
- **Explanations must be compelling.** Explanation-proofs are logical proofs in a natural deduction system, but they must additionally be "compelling" --- leaving "no doubt as to the validity of its conclusions" and containing no hidden assumptions (undischarged premises). This motivated the introduction of RAA (reductio ad absurdum) inference rules. *(p.50--52)*
- **Mythical causality bridges the quasistatic gap.** Since quasistatic models cannot account for change (the device is always at equilibrium), mythical causality introduces a fictional "mythical time" --- a partial ordering that captures how disturbances propagate between components without conventional time passing. This preserves the quasistatic models while enabling causal explanation. *(p.62--63)*
- **Two independent validation paths.** Both "pushing a level" (adding mass/spring to get level-2 models) and mythical causal analysis reveal the same feedback characteristics of the pressure-regulator, providing independent confirmation. The causal analysis additionally detects feedback loops directly. *(p.76)*
- **Ambiguity as feature, not bug.** Multiple interpretations from qualitative constraint satisfaction represent genuine physical ambiguity --- the same qualitative topology can describe physically different devices. "At a minimum, for a prediction to be correct, one of the interpretations must correspond to the actual behavior of the real device." *(p.11, 15)*
- **Canonicality heuristics from human explanations.** The three causality heuristics (component, conduit, confluence) are "abstracted from the kinds of verbal and written explanations human experts give," grounding the computational causality theory in observed human reasoning patterns. *(p.67)*
