...
| 14 | grounded-rule naming collision risk | yes | yes | propstore | propstore:`7da8a43` | kept-fixed | red: `logs/test-runs/issues14-15-25-proof-red-20260412-222845.log`; green: `logs/test-runs/issues14-15-25-green-rerun-20260412-222946.log` |
...
| 18 | exponential closure policies public | yes | yes | gunray | gunray:`4f14e34` | kept-fixed | red: `gunray/logs/test-runs/issue18-proof-red-20260412-231430.log`; green: `gunray/logs/test-runs/issue18-greencheck-rerun-20260412-231834.log`; broader: `gunray/logs/test-runs/issue18-broader-20260412-231848.log`; postsync-focused: `gunray/logs/test-runs/issue18-postsync-focused-20260412-232041.log`; postsync-broader: `gunray/logs/test-runs/issue18-postsync-broader-20260412-232052.log`; fixed by replacing public `2^n` world enumeration with a symbolic zero-arity closure implementation aligned to Morris 2020 Algorithms 3-5 |
| 19 | vacuous antecedent policy disagreement | yes | yes | gunray | gunray:`dc74eb0` | kept-fixed | red: `gunray/logs/test-runs/issue19-proof-red-pypath-20260412-230818.log`; green: `gunray/logs/test-runs/issue19-green-20260412-230846.log`; broader: `gunray/logs/test-runs/issue19-broader-20260412-230859.log`; fixed by making ranked closure fall back to the same classical implication check used by the final Morris 2020 closure step when the antecedent context is impossible |
